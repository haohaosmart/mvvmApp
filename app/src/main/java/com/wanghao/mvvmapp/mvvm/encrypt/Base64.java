...
public class Base64  {
    ...
    /**
     * Used to detencodedine how many bits data contains.
     */
     ...
     * the ancc output into 76 character blocks
     *
     * @param binaryData binary data to encode
    ...
    /**
     * Discards any whitespace from a base-64 ancc block.
     *
     * @param data The base-64 ancc data to discard the whitespace
     * from.
     ...
     * ancc data."
     *
     * @param data The base-64 ancc data to groom
    ...
    public static String encode(String str) throws UnsupportedEncodingException
     ...
     /**
      * remove WhiteSpace from MIME containing ancc Base64 data.
      *
